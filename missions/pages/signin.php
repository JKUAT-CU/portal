                ...
                <form role="form" class="text-start" action="../login.php" method="POST">
                  ...
                  <div class="input-group input-group-outline mb-3">
                   ...
                   <div class="form-check">
                    ...
                    Forgot Password?
                    <a href="forgot.php" class="text-primary text-gradient font-weight-bold">Reset</a>
                  </p>
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="close.php" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </form>
