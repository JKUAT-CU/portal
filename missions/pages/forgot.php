          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                ...
                ?>
                <form role="form" class="text-start" action="../forgotpassword.php" method="POST">
                  ...
                  <p class="mt-4 text-sm text-center">
                    <a href="signin.php" class="text-primary text-gradient font-weight-bold">Back to SignIn</a>
                  </p>
                </form>
