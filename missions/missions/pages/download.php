        ...
        <div class="col-md-6 offset-md-3">
            <div class="image-container">
                <div style="height: 70%; width: 70%; border: .8vh solid red; border-radius: 5%;">
                    ...
                    <img id="imagePreview" src="<?php echo $image_url . '?timestamp=' . time(); ?>" alt="Image Preview" style="height: 100%; width: 100%;">
                    <!-- Download button -->
                    <a id="downloadButton" class="btn btn-primary mt-3" download>Download Proforma</a>
